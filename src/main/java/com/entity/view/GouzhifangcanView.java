...
public class GouzhifangcanView extends GouzhifangcanEntity implements Serializable {
	...
	public GouzhifangcanView() {

	}

	public GouzhifangcanView(GouzhifangcanEntity gouzhifangcanEntity) {
		try {
			BeanUtils.copyProperties(this, gouzhifangcanEntity);
